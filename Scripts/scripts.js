...
function getDetails(keyTerm) {
  ...
  fetch("https://freegeoip.app/json/")
    .then(response => {
      ...
      console.log(loc)
      let url = "https://api.foursquare.com/v2/venues/search/?ll=" + loc + "&query=";
      url += keyTerm;
      ...
      request.onreadystatechange = function() {
        ...
        if (request.readyState === 4 && request.status === 200) {
          ...
          if (response.response.venues.length != 0) {
            ...
            let text = "Unfortunately, there is no " + keyTerm + " near " + data.city  + " at this time. Please visit the " + keyTerm + " website for locations and/or products availible in stores."
